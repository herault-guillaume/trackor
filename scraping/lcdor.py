...
def get(session):
    url = 'https://lcdor.fr/achat-or/pieces-dor/20-francs-or-coq/'
    ...
    try:
        ...
        coin = CoinPrice(nom="20 francs or coq marianne", j_achete=price, source='https://lcdor.fr/achat-or/pieces-dor/20-francs-or-coq/',frais_port=7.0)
        session.add(coin)
        session.commit()
