...
def get_price_for(session,session_id,buy_price):
    ...
    coin_to_name = {
        ...
        'Pièce d’Or 20 Francs Napoléon / Louis d’Or': 'or - 20 francs fr napoléon empereur laurée', # Or 'or - 20 francs fr louis XVIII buste nu' depending on the coin
        ...
        'Pièce d’Or 10 Florins – 10 Gulden': 'or - 10 florins wilhelmina', # Or 'or - 10 florins willem III' depending on the coin
        'Pièce d’Or Krugerrand': 'or - 1 oz krugerrand',
        'Pièce d’Or 10 Francs Napoléon': 'or - 10 francs fr napoléon III laurée', # Or 'or - 10 francs fr napoléon III laurée' depending on the coin
        'Pièce d’Or 20 Francs Tunisie': 'or - 20 francs tunisie',
        'Pièce d’Or Souverain Elizabeth II': 'or - 1 souverain elizabeth II',
        'Pièce d’Or 5 Dollars US': 'or - 5 dollars liberté',  # Or 'or - 5 dollars tête indien' depending on the coin
    }
    ...
    for url in urls :
        try:
            ...
            for p in products:
                ...
                if coin_to_name[product_name][:2] == 'or':
