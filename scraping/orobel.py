    ...
    try:
        ...
        if price_element:
            ...
            try:
                ...
                coin = CoinPrice(nom="20 francs or coq marianne", j_achete=price, source='https://www.orobel.biz/produit/acheter-piece-or-20-francs-marianne-en-ligne-orobel',frais_port=35.0)
                session.add(coin)
                session.commit()
