    ...
    try:
        ...
        if price_element:
            ...
            try:
                ...
                coin = CoinPrice(nom="20 francs or coq marianne", j_achete=price, source='https://www.goldforex.be/fr/cours-de-lor-prix-pieces-lingot-cotation/napoleon-20-francs-france-229.html',frais_port=35.0)
                session.add(coin)
                session.commit()
