    ...
    return dbc.Container(fluid=True, children=[
        dbc.Row(justify="center", children=[
            dbc.Col(lg=10, children=[
                ...
                html.Ul([
                    html.Li(
                        "Scénario : Un investisseur avec un portefeuille diversifié, comprenant des actions, des obligations et des biens immobiliers, alloue 10 % de son portefeuille aux métaux précieux. Il achète un mélange de pièces d'or et d'argent physiques, ainsi que des actions d'un FNB aurifère réputé. Il stocke les métaux physiques dans un coffre-fort bancaire."
                    ),
                    html.Li(
                        "Résultat : Au cours des cinq années suivantes, le marché boursier connaît une correction importante, mais les avoirs en métaux précieux de l'investisseur conservent leur valeur, atténuant les pertes globales du portefeuille. Le FNB minier affiche de bonnes performances, offrant des rendements supplémentaires. Pendant une période d'inflation croissante, l'allocation en métaux précieux protège davantage le pouvoir d'achat du portefeuille.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Leçons apprises : Un portefeuille diversifié qui comprend une allocation stratégique aux métaux précieux peut offrir une protection contre les baisses du marché et l'inflation. La combinaison de métaux physiques avec des investissements liés aux métaux précieux comme les FNB peut offrir une exposition plus large et un potentiel de rendement plus élevé.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
                ...
                html.Ul([
                    html.Li(
                        "Scénario : Un investisseur, novice sur le marché des métaux précieux, achète une collection de pièces d'or sur une place de marché en ligne sans effectuer de recherches approfondies ni d'authentification. Il est attiré par les bas prix et les affirmations du vendeur concernant une teneur élevée en or."
                    ),
                    html.Li(
                        "Résultat : Les pièces s'avèrent être des contrefaçons, fabriquées à partir d'un métal de base plaqué or. L'investisseur perd la totalité de son investissement.",
                        className="mt-3"
                    ),
                    html.Li(
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Atténuation : Les investisseurs peuvent envisager de soutenir les entreprises qui adoptent des pratiques minières durables et des certifications environnementales. Investir dans des métaux précieux recyclés ou récupérés réduit la demande de matériaux nouvellement extraits.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Atténuation : Les investisseurs peuvent effectuer des recherches sur les politiques et les antécédents des entreprises en matière de responsabilité sociale, en soutenant celles qui appliquent des pratiques de travail éthiques et un traitement équitable des communautés locales.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
                ...
                html.P(
                    "Investir dans les métaux précieux, bien qu'offrant des avantages potentiels, n'est pas une voie garantie vers la richesse. Les investisseurs avertis doivent aborder les investissements dans les métaux précieux de manière stratégique, en intégrant les recommandations suivantes :"
                ),

                html.Ul([
                    html.Li(
                        "Diversification : Évitez la surexposition aux métaux précieux. Diversifiez votre portefeuille entre différentes classes d'actifs, y compris les actions, les obligations et l'immobilier."
                    ),
                    html.Li(
                        "Diligence raisonnable : Effectuez des recherches approfondies et authentifiez tout achat de métal précieux physique.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Perspective à long terme : Considérez les métaux précieux comme un investissement à long terme et évitez de prendre des décisions impulsives basées sur les fluctuations de prix à court terme.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Sensibilisation aux coûts : Tenez compte des primes, des coûts de transaction, des frais de stockage et des implications fiscales lors de l'évaluation du rendement potentiel de l'investissement.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Gestion des risques : Comprenez votre tolérance au risque et allouez le capital en conséquence. Utilisez des ordres stop-loss pour limiter les pertes potentielles.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Contrôle émotionnel : Soyez conscient des biais psychologiques et développez des stratégies pour gérer les émotions comme la peur, la cupidité et le regret.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Considérations éthiques : Tenez compte des impacts environnementaux et sociaux de l'exploitation minière et soutenez des pratiques minières responsables.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Conseils professionnels : Consultez un conseiller financier qualifié pour obtenir des conseils personnalisés et une gestion de portefeuille continue.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
