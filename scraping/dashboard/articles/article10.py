        ...
        dbc.Row(justify="center", children=[
            dbc.Col(lg=10, children=[
                ...
                html.Ul([
                    ...
                    html.Li(className="mt-3", children=[
                        html.Span("Leçons apprises : ", className="fw-bold"),
                        "Le platine, bien que volatil, peut offrir des avantages de diversification et un potentiel de croissance à long terme. Une recherche approfondie et une compréhension des facteurs influençant les prix du platine sont essentielles. Une approche diversifiée au sein du secteur du platine, telle que l'investissement dans un panier d'actions minières, peut contribuer à atténuer les risques spécifiques aux entreprises.",
                    ]),
                ], className="list-unstyled"),
