    ...
    return dbc.Container(fluid=True, children=[
        dbc.Row(justify="center", children=[
            dbc.Col(lg=10, children=[
                html.H1(children="Achat de métaux précieux physique: les fondamentaux", className="display-4 text-center mb-4"),
                ...
                html.H2(children="S'approvisionner en métaux précieux : Professionnels vs. Particuliers vs. Places de marché en ligne", className="display-6 mt-5 mb-4"),
                ...
                html.H4(children="Avantages :", className="mb-3"),
                html.Ul(className="list-unstyled", children=[
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        Ils s'occupent souvent et pour vous de faire la déclaration à l'administration fiscale. C'est un point qui est toujours à vérifier avant l'achat ou la vente de métaux précieux."""
                    ]),
                    html.Li(className="mt-3", children=[
                ...
                html.H4(children="Inconvénients :", className="mt-4 mb-3"),
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                ...
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                        ...
                        annonces, peut permettre d'obtenir des prix et des primes plus bas que chez les négociants
                        professionnels. Les vendeurs peuvent être motivés à liquider rapidement leurs métaux précieux ou ne pas
                        être pleinement conscients de la valeur marchande actuelle. Les annonces ne sont pas actualisées
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        permettant aux investisseurs avisés de conclure de meilleures affaires."""
                    ]),
                    html.Li(className="mt-3", children=[
                ...
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                        html.Span("Risque accru de contrefaçons : ", className="fw-bold"),
                ...
                html.H3(children="Places de marché en ligne (eBay, Leboncoin) :", className="display-7 mt-4 mb-3"),
                ...
                html.Ul(className="list-unstyled", children=[
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        """Les plateformes en ligne offrent la commodité de naviguer et d'acheter de n'importe où
                ...
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                        html.Span("Risque élevé de contrefaçon : ", className="fw-bold"),
                ...
                html.H2(children="La prime : le B.A.-BA", className="display-6 mt-5 mb-4"),
                ...
                de primes et utiliser des stratégies avancées pour calculer et comparer les primes peut avoir un impact significatif
                sur le rendement des investissements.""", className="lead"),

                html.H3(children="Calcul des primes :", className="display-7 mt-4 mb-3"),
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                    ...
                    html.Li(className="mt-3", children=[
                        html.Span("Considérations avancées : ", className="fw-bold"),
                ...
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                        html.Span("Entre les produits : ", className="fw-bold"),
                ...
                html.Ul(className="list-unstyled", children=[
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        souvent soumises à la TVA tandis que certaines pièces en sont exemptées."""
                    ]),
                ]),

                html.H2(children="Due diligence", className="display-6 mt-5 mb-4"),
                ...
                Voici quelques stratégies clés :""", className="lead"),
                ...
                html.Ul(className="list-unstyled", children=[
                    html.Li(children=[
                        ...
                        recherchez minutieusement sa réputation et sa légitimité. Consultez les avis en ligne, les forums et les
                        associations professionnelles pour obtenir des commentaires et des plaintes."""
                    ]),
                    html.Li(className="mt-3", children=[
                        ...
                        lorsque vous traitez avec des vendeurs non professionnels. L'inspection visuelle, la vérification du poids,
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        """Soyez pleinement conscient de la teneur en métal, de la pureté, du poids et de toute caractéristique
