    ...
    return dbc.Container(fluid=True, children=[
        dbc.Row(justify="center", children=[
            dbc.Col(lg=10, children=[
                ...
                html.H2("I. Le système monétaire actuel", className="display-6 mt-5 mb-4 fw-bold"),
                ...
                html.H2("II. Les cryptomonnaies comme alternative aux monnaies fiduciaires",
                ...
                html.H2("III. Monnaie décentralisée avec inflation prévisible : Explorer le concept",
                        className="display-6 mt-5 mb-4 fw-bold"),
