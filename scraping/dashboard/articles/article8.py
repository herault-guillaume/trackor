            ...
            dbc.Col(lg=10, children=[
                ...
                html.Ul([
                    ...
                    html.Li(className="mt-3", children=[
                        ...
                        "Pour les pièces achetées auprès de sources moins réputées, l'ouverture de l'emballage pour effectuer une authentification approfondie peut être nécessaire, malgré l'impact potentiel sur la valeur de revente.",
                    ]),
                ], className="list-unstyled"),
