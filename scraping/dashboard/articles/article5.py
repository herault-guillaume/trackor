        ...
        dbc.Row(justify="center", children=[
            dbc.Col(lg=10, children=[
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Contre-argument : Maintenir une allocation précise en pourcentage peut être difficile en raison des fluctuations du marché. Le rééquilibrage constant du portefeuille pour maintenir l'allocation cible peut entraîner des coûts de transaction et potentiellement des implications fiscales. Il est essentiel de laisser une certaine flexibilité et d'éviter les transactions excessives.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),

                # ... (previous parts of the layout function) ...
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Contre-argument : Bien que la DCA soit un outil précieux pour de nombreuses classes d'actifs, elle peut être moins efficace pour les métaux précieux physiques en raison des coûts supplémentaires liés aux primes, à l'expédition et à l'assurance pour chaque transaction. Des achats plus importants et moins fréquents pourraient être plus rentables pour l'acquisition de métal physique.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Surmonter le biais : Reconnaître que les coûts irrécupérables ne sont pas pertinents pour les décisions futures. Fonder les choix d'investissement sur les conditions actuelles du marché, les perspectives d'avenir et la stratégie globale du portefeuille, et non sur les dépenses passées.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
                ...
                html.Ul([
                    ...
                    html.Li(
                        "Aversion aux pertes : La douleur psychologique d'une perte est supérieure au plaisir d'un gain équivalent. Cela peut conduire les investisseurs à conserver des positions perdantes trop longtemps, dans l'espoir d'éviter de réaliser une perte, ou à vendre des positions gagnantes trop tôt, par crainte d'une baisse potentielle.",
                        className="mt-3"
                    ),
                    html.Li(
                        "Mentalité de troupeau : Tendance à suivre la foule, même si cela va à l'encontre de sa propre analyse. En période de battage médiatique ou de crainte, les investisseurs peuvent suivre aveuglément les tendances du marché, ce qui les conduit à acheter à des prix élevés et à vendre à bas prix.",
                        className="mt-3"
                    ),
                ], className="list-unstyled"),
