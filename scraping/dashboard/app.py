...
from articles import article1, article2, article3, article4, article5, article6, article7, article8, article9, article10
    ...
    children=[
        ...
        dbc.DropdownMenu(
            ...
            children=[
                ...
                dbc.DropdownMenuItem("Article 8", href="/articles/article8",id="nav-article8"),
                dbc.DropdownMenuItem("Article 9", href="/articles/article9",id="nav-article9"),
                dbc.DropdownMenuItem("Article 10", href="/articles/article10",id="nav-article10"),
            ],
            nav=True,
            in_navbar=True,
            id="nav-article"
...
header = dbc.Row([html.Img(src='/assets/logo-bullion-sniper.webp', style={'height': '150px', 'width': 'auto'}),
...
@app.callback(Output("page-content", "children"),
              [Input("url", "pathname"),
               ...
               Input("nav-article10", "n_clicks"),
               Input("nav-faq", "n_clicks"),
               Input("nav-whoami", "n_clicks")])

def render_page_content(pathname, n_clicks_home, n_clicks_analyse,
                        ...
                        n_clicks_article10, n_clicks_faq, n_clicks_whoami):
    ...
    if triggered_id == "url" or triggered_id == "nav-home":
        ...
        elif triggered_id == "nav-article3" or pathname == "/articles/3-les-bases":
            return article3.layout()
        elif triggered_id == "nav-article4" or pathname == "/articles/4-les-bases":
            return article4.layout()
        elif triggered_id == "nav-article5" or pathname == "/articles/5-les-bases":
            return article5.layout()
        elif triggered_id == "nav-article6" or pathname == "/articles/6-les-bases":
            return article6.layout()
        elif triggered_id == "nav-article7" or pathname == "/articles/7-les-bases":
            return article7.layout()
        elif triggered_id == "nav-article8" or pathname == "/articles/8-les-bases":
            return article8.layout()
        elif triggered_id == "nav-article9" or pathname == "/articles/9-les-bases":
            return article9.layout()
        elif triggered_id == "nav-article10" or pathname == "/articles/10-les-bases":
            return article10.layout()
            ...
            html.Thead(
                html.Tr([
                    html.Th([html.I(className="fa-solid fa-shop", style={'font-size': '16px'}), "  Site marchand",
                             html.Span(id='source-arrow', className="fa fa-sort ms-2")], style={'text-align': 'center'},
                            id='source-header', n_clicks=0),
                    html.Th([html.I(className="fa-solid fa-hashtag", style={'font-size': '16px'}), "  Nom",
                             html.Span(id='name-arrow', className="fa fa-sort ms-2")], style={'text-align': 'center'},
                    ...
                    html.Th([html.I(className="fa-solid fa-tag", style={'font-size': '16px'}), "  Total FDPI",
                            ...
                            style={'text-align': 'center'}, id='total_cost-header', n_clicks=0),
